    ...
    <div>
      <div className="repo-card-div" key={repo.node.id} onClick={() => openRepoinNewTab(repo.node.url)}>
        <div className="repo-name-div">
          <svg aria-hidden="true" className="octicon" height="16" role="img" viewBox="0 0 12 16" width="12" >
            <path
              fill-rule="evenodd"
        ...
        <div className="repo-stats">
          <div className="repo-left-stat">
            ...
            <span>
              <svg aria-hidden="true" className="octicon" height="16" role="img" viewBox="0 0 10 16" width="10" fill="rgb(106, 115, 125)" >
                <path
                  fill-rule="evenodd"
